...
experiment = 'cascade_rcnn_r50_20e_8b_warm-up_custom'
image_size = (
    1280,
    1280,
)
launcher = 'none'
load_from = '/home/jaa/Work/Prog/BSU/Detectors/work_dirs/cascade_rcnn/cascade_rcnn_r50_20e_8b_warm-up_custom/best_epoch_13.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    type='OptimWrapper')
param_scheduler = [
    dict(begin=0, by_epoch=True, end=4, start_factor=0.001, type='LinearLR'),
    dict(
        begin=4,
        by_epoch=True,
        end=20,
...
vis_backends = [
    dict(
        init_kwargs=dict(
            group='2stage',
            name='cascade_rcnn_r50_20e_b8_warm-up',
...
weights = 'cascade_rcnn_r50_fpn_20e_coco_bbox_mAP-0.41_20200504_175131-e9872a90.pth'
work_dir = '/home/jaa/Work/Prog/BSU/Detectors/work_dirs/cascade_rcnn/cascade_rcnn_r50_20e_8b_warm-up_custom/'
