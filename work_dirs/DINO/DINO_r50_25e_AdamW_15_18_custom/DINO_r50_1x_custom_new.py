...
experiment = 'DINO_r50_25e_AdamW_15_18_custom'
launcher = 'none'
load_from = '/home/jaa/Work/Prog/BSU/Detectors/work_dirs/DINO/DINO_r50_25e_AdamW_15_18_custom/best_epoch_24.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    type='OptimWrapper')
param_scheduler = [
    dict(begin=0, by_epoch=True, end=1, start_factor=0.001, type='LinearLR'),
    dict(
        begin=1,
        by_epoch=True,
        end=25,
...
vis_backends = [
    dict(
        init_kwargs=dict(
            group='transformer',
            name='DINO_r50_25e_b2_AdamW_15_18',
...
weights = 'dino-4scale_r50_improved_8xb2-12e_coco_20230818_162607-6f47a913.pth'
work_dir = '/home/jaa/Work/Prog/BSU/Detectors/work_dirs/DINO/DINO_r50_25e_AdamW_15_18_custom/'
